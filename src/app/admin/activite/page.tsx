...
function labelOf(action: string): string {
  const map: Record<string, string> = {
    ...
    "loan.disburse.superadmin": "Prêt décaissé (super admin)",
    "loan.disburse.settled": "Prêt historique soldé",
    "loan.disburse.settled.superadmin": "Prêt historique soldé (super admin)",
    "loan.disburse.partial": "Prêt avec tranches historiques",
    "loan.disburse.partial.superadmin":
      "Prêt avec tranches historiques (super admin)",
    "loan.approve": "Prêt validé",
    "loan.reject": "Prêt refusé",
    "loan.update": "Prêt modifié",
    "loan.delete": "Prêt supprimé",
