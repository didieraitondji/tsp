...
/** Filtre tontine + recherche pour la vue Inscrits. */
export function InscritsTontineFilter({
  ...
  const hasExtraFilters = Boolean(
    query.trim() || du || au || (statut && statut !== "all")
  );

  return (
    <div className="flex flex-wrap items-center gap-2.5">
      <label className="relative block min-w-[12rem] flex-1 sm:max-w-[14rem]">
